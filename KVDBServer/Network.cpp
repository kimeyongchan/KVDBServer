...
//                        receiveHandlerPointerList[connectInfo->serverModule]->IsConnected(connectInfo);
                ...
                if (readCnt > 0)
                {
                    ...
                    while(true)
                    {
                        ...
                        {
                            if(wholeRecvBufferSize < sizeof(dataSize_t))
                            {
                        ...
                        else
                        {
                            ...
                            {
                                connectInfo->tempBufferInfo.tempBufferSize = wholeRecvBufferSize;
                                connectInfo->tempBufferInfo.tempBuffer = wholeRecvBuffer;
                        ...
                        int recvDataSize = wholeRecvBufferSize - sizeof(dataSize);
                    
                        if(dataSize == recvDataSize)
                        {
                            //ToDo. ping?
                            ...
                            else
                            {
                                ...
                                //receiveHandlerPointerList[connectInfo->serverModule]->Parse(connectInfo, pWholeRecvBuffer, recvDataSize);
                                sendDataToWorkerThread(connectInfo, pWholeRecvBuffer, recvDataSize);
                            }
                            
                            
                            if(isTempBufferInfoEmpty == false)
                            {
                                free(wholeRecvBuffer);
                            }
                        ...
                        else
                        {
                            ...
                            else
                            {
                                DebugLog("");
                                connectInfo->flags |= FLAG_PROCESSING;
                                //receiveHandlerPointerList[connectInfo->serverModule]->Parse(connectInfo, pWholeRecvBuffer, (int)dataSize);
                            ...
                            else
                            {
                                ...
                                wholeRecvBufferSize = wholeRecvBufferSize - ((int)dataSize + sizeof(dataSize) + tempBufferSize);
                                wholeRecvBuffer = recvBuffer + dataSize + sizeof(dataSize) - tempBufferSize;
                            }
                ...
                {
                    DebugLog("");
                    //receiveHandlerPointerList[connectInfo->serverModule]->IsDisconnected(connectInfo);
